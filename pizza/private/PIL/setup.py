...
"""
    ...
    This module is provided for Ubuntu 18.04
   ...
   **   A T T E N T I O N  **
    ...
    If it works, you should see a folder Pizza3/pizza/private/PIL/dist/
    with an egg file. On Linux:
        UNKNOWN-9.2.0.dev0-py3.9-linux-x86_64.egg
    Extract manually the following file _imaging.cpython-39-x86_64-linux-gnu.so
    and copy it to Pizza3/pizza/private/PIL
    
    The generated folders can be deleted:
        rm -rf build/
        rm -rf dist/
...
# customized PIL for Pizza3
# last edition ob April 23, 2022 (olivier.vitrac@agroparistech.fr)
