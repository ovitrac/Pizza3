...
Generated on: **2025-01-19 19:09:36**
...
**[Class Examples for `pizza/private/mstruct.py` (15)](class_examples.html#pizza_private_mstruct)**

### Methods Table

| Class | Method | Docstring First Paragraph | # Lines | __version__ |
|-------|---------|---------------------------|---------|-------------|
| `AttrErrorDict` | `__getitem__` | x.__getitem__(y) <==> x[y] | 5 | 1.003 |
| `SafeEvaluator` | `__init__` | Initialize self.  See help(type(self)) for accurate signature. | 30 | 1.003 |
| `SafeEvaluator` | `evaluate` |  | 3 | 1.003 |
| `SafeEvaluator` | `generic_visit` | Called if no explicit visitor function exists for a node. | 2 | 1.003 |
| `SafeEvaluator` | `visit_Attribute` |  | 12 | 1.003 |
| `SafeEvaluator` | `visit_BinOp` |  | 9 | 1.003 |
| `SafeEvaluator` | `visit_Call` |  | 7 | 1.003 |
| `SafeEvaluator` | `visit_Constant` |  | 2 | 1.003 |
| `SafeEvaluator` | `visit_ExtSlice` |  | 3 | 1.003 |
| `SafeEvaluator` | `visit_Index` |  | 2 | 1.003 |
| `SafeEvaluator` | `visit_List` |  | 2 | 1.003 |
| `SafeEvaluator` | `visit_Name` |  | 4 | 1.003 |
| `SafeEvaluator` | `visit_Slice` |  | 5 | 1.003 |
| `SafeEvaluator` | `visit_Subscript` |  | 7 | 1.003 |
| `SafeEvaluator` | `visit_Tuple` |  | 2 | 1.003 |
| `SafeEvaluator` | `visit_UnaryOp` |  | 6 | 1.003 |
| `param` | `__add__` | add a structure set sortdefintions=True to sort definitions (to maintain executability) | 10 | 1.003 |
| `param` | `__call__` | Extract a sub-structure based on the specified keys, keeping the same class type. | 35 | 1.003 |
| `param` | `__contains__` | in override | 3 | 1.003 |
| `param` | `__copy__` | copy method | 6 | 1.003 |
| `param` | `__deepcopy__` | deep copy method | 8 | 1.003 |
| `param` | `__delattr__` | Delete an instance attribute if it exists and is not a class or excluded attribute. | 10 | 1.003 |
| `param` | `__getattr__` | get attribute override | 3 | 1.003 |
| `param` | `__getitem__` | s[i] returns the ith element of the structure s[:4] returns a structure with the four first fields s[[1,3]] returns the second and fourth elements | 26 | 1.003 |
| `param` | `__getstate__` | getstate for cooperative inheritance / duplication | 3 | 1.003 |
| `param` | `__iadd__` | iadd a structure set sortdefintions=True to sort definitions (to maintain executability) | 9 | 1.003 |
| `param` | `__init__` | constructor | 7 | 1.003 |
| `param` | `__isub__` | isub a structure | 9 | 1.003 |
| `param` | `__iter__` | struct iterator | 6 | 1.003 |
| `param` | `__len__` | return the number of fields | 4 | 1.003 |
| `param` | `__next__` | increment iterator | 7 | 1.003 |
| `param` | `__repr__` | display method | 61 | 1.003 |
| `param` | `__setattr__` | set attribute override | 3 | 1.003 |
| `param` | `__setitem__` | set the ith element of the structure | 24 | 1.003 |
| `param` | `__setstate__` | setstate for cooperative inheritance / duplication | 3 | 1.003 |
| `param` | `__str__` | Return str(self). | 2 | 1.003 |
| `param` | `__sub__` | sub a structure | 10 | 1.003 |
| `param` | `check` | populate fields from a default structure check(defaultstruct) missing field, None and [] values are replaced by default ones | 19 | 1.003 |
| `param` | `clear` | clear() delete all fields while preserving the original class | 3 | 1.003 |
| `param` | `dict2struct` | create a structure from a dictionary | 8 | 1.003 |
| `param` | `disp` | display method | 3 | 1.003 |
| `param` | `dispmax` | optimize display | 8 | 1.003 |
| `param` | `escape` | escape \${} as ${{}} --> keep variable names convert ${} as {} --> prepare Python replacement | 35 | 1.003 |
| `param` | `eval` | Eval method for structure such as MS.alias | 114 | 1.003 |
| `param` | `format` | Format a string with fields using {field} as placeholders. Handles expressions like ${variable1}. | 32 | 1.003 |
| `param` | `format_array` | Format NumPy array for display with distinctions for row and column vectors. | 41 | 1.003 |
| `param` | `format_legacy` | format a string with field (use {field} as placeholders) s.replace(string), s.replace(string,escape=True) where: s is a struct object string is a string with possibly ${variable1} escape is a flag to prevent ${} replaced by {} | 27 | 1.003 |
| `param` | `formateval` | format method with evaluation feature | 44 | 1.003 |
| `param` | `fromkeys` | returns a structure from keys | 3 | 1.003 |
| `param` | `fromkeysvalues` | struct.keysvalues(keys,values) creates a structure from keys and values use makeparam = True to create a param instead of struct | 18 | 1.003 |
| `param` | `generator` | generate Python code of the equivalent structure | 21 | 1.003 |
| `param` | `getattr` | Get attribute override to access both instance attributes and properties if allowed. | 11 | 1.003 |
| `param` | `hasattr` | Return true if the field exists, considering properties as regular attributes if allowed. | 7 | 1.003 |
| `param` | `isdefined` | isdefined(ref) returns true if it is defined in ref | 19 | 1.003 |
| `param` | `isstrdefined` | isstrdefined(string,ref) returns true if it is defined in ref | 14 | 1.003 |
| `param` | `isstrexpression` | isstrexpression(string) returns true if s contains an expression | 5 | 1.003 |
| `param` | `items` | return all elements as iterable key, value | 3 | 1.003 |
| `param` | `keys` | return the fields | 4 | 1.003 |
| `param` | `keyssorted` | sort keys by length() | 5 | 1.003 |
| `param` | `protect` | protect $variable as ${variable} | 11 | 1.003 |
| `param` | `read` | read the equivalent structure read(filename) | 35 | 1.003 |
| `param` | `safe_fstring` | Safely evaluate expressions in ${} using SafeEvaluator. | 58 | 1.003 |
| `param` | `scan` | scan(string) scan a string for variables | 11 | 1.003 |
| `param` | `set` | initialization | 3 | 1.003 |
| `param` | `setattr` | set field and value | 6 | 1.003 |
| `param` | `sortdefinitions` | sortdefintions sorts all definitions so that they can be executed as param(). If any inconsistency is found, an error message is generated. | 53 | 1.003 |
| `param` | `struct2dict` | create a dictionary from the current structure | 3 | 1.003 |
| `param` | `struct2param` | convert an object struct() to param() | 8 | 1.003 |
| `param` | `tostatic` | convert dynamic a param() object to a static struct() object. note: no interpretation note: use tostruct() to interpret them and convert it to struct note: tostatic().struct2param() makes it reversible | 7 | 1.003 |
| `param` | `tostruct` | generate the evaluated structure tostruct(protection=False) | 6 | 1.003 |
| `param` | `update` | Update multiple fields at once, while protecting certain attributes. | 22 | 1.003 |
| `param` | `values` | return the values | 4 | 1.003 |
| `param` | `write` | write the equivalent structure (not recursive for nested struct) write(filename, overwrite=True, mkdir=False) | 33 | 1.003 |
| `param` | `zip` | zip keys and values | 3 | 1.003 |
| `paramauto` | `__add__` | add a structure set sortdefintions=True to sort definitions (to maintain executability) | 2 | 1.003 |
| `paramauto` | `__call__` | Extract a sub-structure based on the specified keys, keeping the same class type. | 35 | 1.003 |
| `paramauto` | `__contains__` | in override | 3 | 1.003 |
| `paramauto` | `__copy__` | copy method | 6 | 1.003 |
| `paramauto` | `__deepcopy__` | deep copy method | 8 | 1.003 |
| `paramauto` | `__delattr__` | Delete an instance attribute if it exists and is not a class or excluded attribute. | 10 | 1.003 |
| `paramauto` | `__getattr__` | get attribute override | 3 | 1.003 |
| `paramauto` | `__getitem__` | s[i] returns the ith element of the structure s[:4] returns a structure with the four first fields s[[1,3]] returns the second and fourth elements | 26 | 1.003 |
| `paramauto` | `__getstate__` | getstate for cooperative inheritance / duplication | 3 | 1.003 |
| `paramauto` | `__iadd__` | iadd a structure set sortdefintions=True to sort definitions (to maintain executability) | 2 | 1.003 |
| `paramauto` | `__init__` | constructor | 7 | 1.003 |
| `paramauto` | `__isub__` | isub a structure | 9 | 1.003 |
| `paramauto` | `__iter__` | struct iterator | 6 | 1.003 |
| `paramauto` | `__len__` | return the number of fields | 4 | 1.003 |
| `paramauto` | `__next__` | increment iterator | 7 | 1.003 |
| `paramauto` | `__repr__` | display method | 5 | 1.003 |
| `paramauto` | `__setattr__` | set attribute override | 3 | 1.003 |
| `paramauto` | `__setitem__` | set the ith element of the structure | 24 | 1.003 |
| `paramauto` | `__setstate__` | setstate for cooperative inheritance / duplication | 3 | 1.003 |
| `paramauto` | `__str__` | Return str(self). | 2 | 1.003 |
| `paramauto` | `__sub__` | sub a structure | 10 | 1.003 |
| `paramauto` | `check` | populate fields from a default structure check(defaultstruct) missing field, None and [] values are replaced by default ones | 19 | 1.003 |
| `paramauto` | `clear` | clear() delete all fields while preserving the original class | 3 | 1.003 |
| `paramauto` | `dict2struct` | create a structure from a dictionary | 8 | 1.003 |
| `paramauto` | `disp` | display method | 3 | 1.003 |
| `paramauto` | `dispmax` | optimize display | 8 | 1.003 |
| `paramauto` | `escape` | escape \${} as ${{}} --> keep variable names convert ${} as {} --> prepare Python replacement | 35 | 1.003 |
| `paramauto` | `eval` | Eval method for structure such as MS.alias | 114 | 1.003 |
| `paramauto` | `format` | Format a string with fields using {field} as placeholders. Handles expressions like ${variable1}. | 32 | 1.003 |
| `paramauto` | `format_array` | Format NumPy array for display with distinctions for row and column vectors. | 41 | 1.003 |
| `paramauto` | `format_legacy` | format a string with field (use {field} as placeholders) s.replace(string), s.replace(string,escape=True) where: s is a struct object string is a string with possibly ${variable1} escape is a flag to prevent ${} replaced by {} | 27 | 1.003 |
| `paramauto` | `formateval` | format method with evaluation feature | 44 | 1.003 |
| `paramauto` | `fromkeys` | returns a structure from keys | 3 | 1.003 |
| `paramauto` | `fromkeysvalues` | struct.keysvalues(keys,values) creates a structure from keys and values use makeparam = True to create a param instead of struct | 18 | 1.003 |
| `paramauto` | `generator` | generate Python code of the equivalent structure | 21 | 1.003 |
| `paramauto` | `getattr` | Get attribute override to access both instance attributes and properties if allowed. | 11 | 1.003 |
| `paramauto` | `hasattr` | Return true if the field exists, considering properties as regular attributes if allowed. | 7 | 1.003 |
| `paramauto` | `isdefined` | isdefined(ref) returns true if it is defined in ref | 19 | 1.003 |
| `paramauto` | `isstrdefined` | isstrdefined(string,ref) returns true if it is defined in ref | 14 | 1.003 |
| `paramauto` | `isstrexpression` | isstrexpression(string) returns true if s contains an expression | 5 | 1.003 |
| `paramauto` | `items` | return all elements as iterable key, value | 3 | 1.003 |
| `paramauto` | `keys` | return the fields | 4 | 1.003 |
| `paramauto` | `keyssorted` | sort keys by length() | 5 | 1.003 |
| `paramauto` | `protect` | protect $variable as ${variable} | 11 | 1.003 |
| `paramauto` | `read` | read the equivalent structure read(filename) | 35 | 1.003 |
| `paramauto` | `safe_fstring` | Safely evaluate expressions in ${} using SafeEvaluator. | 58 | 1.003 |
| `paramauto` | `scan` | scan(string) scan a string for variables | 11 | 1.003 |
| `paramauto` | `set` | initialization | 3 | 1.003 |
| `paramauto` | `setattr` | set field and value | 6 | 1.003 |
| `paramauto` | `sortdefinitions` | sortdefintions sorts all definitions so that they can be executed as param(). If any inconsistency is found, an error message is generated. | 53 | 1.003 |
| `paramauto` | `struct2dict` | create a dictionary from the current structure | 3 | 1.003 |
| `paramauto` | `struct2param` | convert an object struct() to param() | 8 | 1.003 |
| `paramauto` | `tostatic` | convert dynamic a param() object to a static struct() object. note: no interpretation note: use tostruct() to interpret them and convert it to struct note: tostatic().struct2param() makes it reversible | 7 | 1.003 |
| `paramauto` | `tostruct` | generate the evaluated structure tostruct(protection=False) | 6 | 1.003 |
| `paramauto` | `update` | Update multiple fields at once, while protecting certain attributes. | 22 | 1.003 |
| `paramauto` | `values` | return the values | 4 | 1.003 |
| `paramauto` | `write` | write the equivalent structure (not recursive for nested struct) write(filename, overwrite=True, mkdir=False) | 33 | 1.003 |
| `paramauto` | `zip` | zip keys and values | 3 | 1.003 |
| `pstr` | `__add__` | Return self+value. | 2 | 1.003 |
| `pstr` | `__iadd__` |  | 2 | 1.003 |
| `pstr` | `__repr__` | Return repr(self). | 5 | 1.003 |
| `pstr` | `__truediv__` | overload / | 7 | 1.003 |
| `pstr` | `eval` | evaluate the path of it os a path | 9 | 1.003 |
| `pstr` | `topath` | return a validated path | 6 | 1.003 |
| `struct` | `__add__` | add a structure set sortdefintions=True to sort definitions (to maintain executability) | 10 | 1.003 |
| `struct` | `__call__` | Extract a sub-structure based on the specified keys, keeping the same class type. | 35 | 1.003 |
| `struct` | `__contains__` | in override | 3 | 1.003 |
| `struct` | `__copy__` | copy method | 6 | 1.003 |
| `struct` | `__deepcopy__` | deep copy method | 8 | 1.003 |
| `struct` | `__delattr__` | Delete an instance attribute if it exists and is not a class or excluded attribute. | 10 | 1.003 |
| `struct` | `__getattr__` | get attribute override | 3 | 1.003 |
| `struct` | `__getitem__` | s[i] returns the ith element of the structure s[:4] returns a structure with the four first fields s[[1,3]] returns the second and fourth elements | 26 | 1.003 |
| `struct` | `__getstate__` | getstate for cooperative inheritance / duplication | 3 | 1.003 |
| `struct` | `__iadd__` | iadd a structure set sortdefintions=True to sort definitions (to maintain executability) | 9 | 1.003 |
| `struct` | `__init__` | constructor | 5 | 1.003 |
| `struct` | `__isub__` | isub a structure | 9 | 1.003 |
| `struct` | `__iter__` | struct iterator | 6 | 1.003 |
| `struct` | `__len__` | return the number of fields | 4 | 1.003 |
| `struct` | `__next__` | increment iterator | 7 | 1.003 |
| `struct` | `__repr__` | display method | 61 | 1.003 |
| `struct` | `__setattr__` | set attribute override | 3 | 1.003 |
| `struct` | `__setitem__` | set the ith element of the structure | 24 | 1.003 |
| `struct` | `__setstate__` | setstate for cooperative inheritance / duplication | 3 | 1.003 |
| `struct` | `__str__` | Return str(self). | 2 | 1.003 |
| `struct` | `__sub__` | sub a structure | 10 | 1.003 |
| `struct` | `check` | populate fields from a default structure check(defaultstruct) missing field, None and [] values are replaced by default ones | 19 | 1.003 |
| `struct` | `clear` | clear() delete all fields while preserving the original class | 3 | 1.003 |
| `struct` | `dict2struct` | create a structure from a dictionary | 8 | 1.003 |
| `struct` | `disp` | display method | 3 | 1.003 |
| `struct` | `dispmax` | optimize display | 8 | 1.003 |
| `struct` | `format` | Format a string with fields using {field} as placeholders. Handles expressions like ${variable1}. | 32 | 1.003 |
| `struct` | `format_array` | Format NumPy array for display with distinctions for row and column vectors. | 41 | 1.003 |
| `struct` | `format_legacy` | format a string with field (use {field} as placeholders) s.replace(string), s.replace(string,escape=True) where: s is a struct object string is a string with possibly ${variable1} escape is a flag to prevent ${} replaced by {} | 27 | 1.003 |
| `struct` | `fromkeys` | returns a structure from keys | 3 | 1.003 |
| `struct` | `fromkeysvalues` | struct.keysvalues(keys,values) creates a structure from keys and values use makeparam = True to create a param instead of struct | 18 | 1.003 |
| `struct` | `generator` | generate Python code of the equivalent structure | 21 | 1.003 |
| `struct` | `getattr` | Get attribute override to access both instance attributes and properties if allowed. | 11 | 1.003 |
| `struct` | `hasattr` | Return true if the field exists, considering properties as regular attributes if allowed. | 7 | 1.003 |
| `struct` | `isdefined` | isdefined(ref) returns true if it is defined in ref | 19 | 1.003 |
| `struct` | `isstrdefined` | isstrdefined(string,ref) returns true if it is defined in ref | 14 | 1.003 |
| `struct` | `isstrexpression` | isstrexpression(string) returns true if s contains an expression | 5 | 1.003 |
| `struct` | `items` | return all elements as iterable key, value | 3 | 1.003 |
| `struct` | `keys` | return the fields | 4 | 1.003 |
| `struct` | `keyssorted` | sort keys by length() | 5 | 1.003 |
| `struct` | `read` | read the equivalent structure read(filename) | 35 | 1.003 |
| `struct` | `scan` | scan(string) scan a string for variables | 11 | 1.003 |
| `struct` | `set` | initialization | 3 | 1.003 |
| `struct` | `setattr` | set field and value | 6 | 1.003 |
| `struct` | `sortdefinitions` | sortdefintions sorts all definitions so that they can be executed as param(). If any inconsistency is found, an error message is generated. | 53 | 1.003 |
| `struct` | `struct2dict` | create a dictionary from the current structure | 3 | 1.003 |
| `struct` | `struct2param` | convert an object struct() to param() | 8 | 1.003 |
| `struct` | `update` | Update multiple fields at once, while protecting certain attributes. | 22 | 1.003 |
| `struct` | `values` | return the values | 4 | 1.003 |
| `struct` | `write` | write the equivalent structure (not recursive for nested struct) write(filename, overwrite=True, mkdir=False) | 33 | 1.003 |
| `struct` | `zip` | zip keys and values | 3 | 1.003 |
...
| `scriptobject` | `__init__` | constructor | 30 | 1.003 |
